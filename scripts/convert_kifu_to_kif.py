...
class ConvertKifuToKif():

    def convert_kifu_to_kif(self, input_file, output_folder, debug=False):
        ...
        if ConvertKifuToKif.is_utf8_file_with_bom(input_file):
            encoding = 'utf-8-sig'
        else:
            encoding = 'utf-8'
    ...
    @classmethod
    def is_utf8_file_with_bom(clazz, filename):
