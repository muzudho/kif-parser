...
def convert_pivot_to_kifu(pivot_file, output_folder, desinated_template_name="", debug=False):
    """
    Parameters
    ----------
    ...
    out_path = os.path.join(output_folder, f"{stem}[{template_obj.name}].kifu")
